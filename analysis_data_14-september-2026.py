...
def plot_multiple_curves_wavelength():
    x_arrays, y_arrays, legend_arr = [], [], []
    
    for linewidth in LINEWIDTHS:
        # for wavelength in WAVELENGTHS:
        for wavelength in [1056, 1057, 1058, 1059, 1061,1062, 1063, 1064, 1067]:
            
            txt_file = (
                r"C:\Users\namys\Documents\DATA_dual_wavelength_laser"
                r"\LD_set_current_9.83A_September-13-2026_time_10-18-08\graphs"
                rf"\linewidth_{linewidth}nm\freq_vs_time_linewidth_{linewidth}nm_wavelength_{wavelength}nm.txt"
                
            )
            iter_arr, freq_arr = read_txt_xy(file_path=txt_file)
            x_arrays.append(iter_arr)
            y_arrays.append(freq_arr)
            legend_arr.append(f'WL={wavelength}nm')
        ...
        plot_multiple_curves(
            ...
            xlabel=x_label,
            ylabel=y_label,
            folder_path=r"C:\Users\namys\Documents\DATA_dual_wavelength_laser\LD_set_current_9.83A_September-13-2026_time_10-18-08\graphs\linewidth_2nm",
            filename="combined_plot"
        )
        
plot_multiple_curves_wavelength()
# plot_graphs_freq_vs_time()